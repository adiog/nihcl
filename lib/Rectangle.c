...
DEFINE_CLASS(Rectangle,2,"$Header: /afs/alw.nih.gov/unix/sun4_40c/usr/local/src/nihcl-3.0/share/lib/RCS/Rectangle.c,v 3.0 90/05/20 00:20:58 kgorlen Rel $",NULL,NULL);
