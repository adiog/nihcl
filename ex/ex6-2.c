// ex6-2.c -- Improved geometry class hierarchy

// $Header: /afs/alw.nih.gov/unix/sun4_40c/usr/local/src/nihcl-3.0/share/ex/RCS/ex6-2.c,v 3.0 90/05/15 22:45:42 kgorlen Rel $
...
public:
    Picture() : Shape(Point(0,0))    { n = 0; } // constructor
    Picture(Point& org) : Shape(org) { n = 0; } // constructor
