...
/*$Header: /afs/alw.nih.gov/unix/sun4_40c/usr/local/src/nihcl-3.0/share/lib/RCS/Object.h,v 3.0 90/05/22 10:42:35 kgorlen Rel $*/
...
{ \
	if (Class::_storeVBase((const void*)this)) classname::storer(fd); \
} \
void classname::storeVBaseOn(OIOout& strm) const \
{ \
	if (Class::_storeVBase((const void*)this)) classname::storer(strm); \
} \
...
private:			// member variables
	...
	const initorTy class_initor2;		// phase 2 class initor
